...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_a_product_no_id(self):
        """It should attempt to Update a Product without an id"""
        products = Product.all()
        self.assertEqual(products, [])
        product = ProductFactory()
        product.id = None
    ...
    def test_deserialize_available_not_bool(self):
        """It should attempt to deserialize a product from a dictionary with 'available' field as a string"""
        product = Product()
        product_dict = {
            "name": "Fizz",
            "description": "Buzz",
    ...
    def test_deserialize_available_invalid_arg(self):
        """It should attempt to deserialize a product from a dictionary with non-dictionary arg"""
        product = Product()
        product_dict = "string"
        self.assertRaises(DataValidationError, product.deserialize, product_dict)

    def test_deserialize_missing_key(self):
        """It should attempt to deserialize a product from a dictionary with no 'name' field"""
        product = Product()
        product_dict = {
            "description": "Buzz",
            "price": 10.10,
    ...
    def test_deserialize_missing_attribute(self):
        """It should attempt to deserialize a product from a dictionary with invalid category"""
        product = Product()
        product_dict = {
            "name": "Fizz",
            "description": "Buzz",
